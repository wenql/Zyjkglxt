    ...
    appModule.controller('main.views.layout.header', [
        ...
        function ($rootScope, $scope, $uibModal, appSession, appUserNotificationHelper, notificationService, userLinkService) {
            ...
            vm.editMySettings = function () {
                $uibModal.open({
                    templateUrl: '~/App/main/views/profile/mySettingsModal.cshtml',
                    controller: 'main.views.profile.mySettingsModal as vm',
                    backdrop: 'static'
                });
            };
            ...
            vm.changePassword = function () {
                $uibModal.open({
                    ...
                    controller: 'main.views.profile.changePassword as vm',
                    backdrop: 'static'
                });
            };
            ...
            vm.changePicture = function () {
                $uibModal.open({
                    templateUrl: '~/App/main/views/profile/changePicture.cshtml',
                    controller: 'main.views.profile.changePicture as vm',
                    backdrop: 'static'
                });
            };
            ...
            vm.manageLinkedAccounts = function () {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/main/views/profile/linkedAccountsModal.cshtml',
                    controller: 'main.views.profile.linkedAccountsModal as vm',
                    backdrop: 'static'
                });
            ...
            vm.showLoginAttempts = function () {
                $uibModal.open({
                    templateUrl: '~/App/main/views/users/loginAttemptsModal.cshtml',
                    controller: 'main.views.users.loginAttemptsModal as vm',
                    backdrop: 'static'
                });
            };
